    ...
    <div className='navCont'>
      ...
      <div className="sidebar">
        <div className='nav'>
          ...
          <Link to="/categories" className='nav-comp'>Events</Link>
          <Link to="/sponsors" className='nav-comp'>Sponsors</Link>
          <Link to="/lectures" className='nav-comp'>Lectures</Link>
          <Link to="/Team" className='nav-comp'>Team Tech</Link>
          <Link to="/devs" className='nav-comp'>Developers</Link>
          <Link to="/about" className='nav-comp'>About Us</Link>
        </div>
      </div>
    </div>
    </>
